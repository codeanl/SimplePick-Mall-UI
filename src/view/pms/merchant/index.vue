<template>
    ...
    <el-dialog v-model="drawer1" width="70%" :before-close="beforeCloseHandler">
        ...
        <el-table border :data="listArr1" @selection-change="selectChange" style="margin:15px 0">
            ...
            <el-table-column label="名称" align="center" prop="name" show-overflow-tooltip></el-table-column>
            <el-table-column label="负责人" align="center" prop="principalName" show-overflow-tooltip></el-table-column>
            <el-table-column label="联系电话" align="center" prop="principalPhone" show-overflow-tooltip></el-table-column>
            <el-table-column label="地址" align="center" prop="address" show-overflow-tooltip></el-table-column>
            <el-table-column label="操作" width="300px" align="center">
                <template #="{ row }">
                    <el-button type="primary" size="small" icon="Edit" @click="lookInfo(row)">
                        查看详情
                    </el-button>
                </template>
            </el-table-column>
        ...
        <el-pagination v-model:current-page="pageNo1" v-model:page-size="pageSize1" :page-sizes="[5, 10, 15, 20]"
            ...
            @current-change="getHas1" @size-change="handler1" />
    </el-dialog>
    <!--  -->
    <el-dialog v-model="drawer2" width="70%" title="店铺申请详情">
        <el-descriptions direction="horizontal" :column="1" :size="size" border>
            ...
            <el-descriptions-item label="收货人">{{ merchantsApply.principalName }}</el-descriptions-item>
            <el-descriptions-item label="联系电话">{{ merchantsApply.principalPhone }}</el-descriptions-item>
            <el-descriptions-item label="地址">{{ merchantsApply.address }}</el-descriptions-item>
