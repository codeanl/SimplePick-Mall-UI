<template>
    ...
    <el-card>
        ...
        <el-table border style="margin: 15px 0" :data="allRole" @selection-change="selectChange">
            ...
            <el-table-column label="更新者" align="center" show-overflow-tooltip prop="update_by"></el-table-column>
...
const getHasRole = async (pager = 1) => {
    pageNo.value = pager
    let res: any = await reqAllRoleList(pageNo.value, pageSize.value, keyword.value)
    if (res.code === 200) {
