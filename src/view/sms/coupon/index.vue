<template>
        ...
        <el-form :inline="true">
            ...
            <el-form-item>
                <el-button type="primary" size="default" @click="search"
                    :disabled="name.length || type.length || useType.length ? false : true">
                    搜索
                </el-button>
    ...
    <el-card>
        ...
        <el-table border :data="listArr" @selection-change="selectChange" style="margin: 15px 0">
            ...
            <el-table-column label="使用类型" align="center" prop="useType" show-overflow-tooltip>
                <template #="{ row }">
            ...
            <el-table-column label="数量" align="center" prop="count" show-overflow-tooltip></el-table-column>
            <el-table-column label="金额" align="center" prop="amount" show-overflow-tooltip></el-table-column>
            <el-table-column label="每人限领张数" align="center" prop="perLimit" show-overflow-tooltip></el-table-column>
            <el-table-column label="使用门槛" align="center" prop="minPoint" show-overflow-tooltip></el-table-column>
            <el-table-column label="开始时间" align="center" prop="startTime" show-overflow-tooltip></el-table-column>
            <el-table-column label="结束时间" align="center" prop="endTime" show-overflow-tooltip></el-table-column>
            <el-table-column label="开始领取时间" align="center" prop="enableTime" show-overflow-tooltip></el-table-column>
            <el-table-column label="备注" align="center" prop="note" show-overflow-tooltip></el-table-column>
            <el-table-column label="优惠码" align="center" prop="code" show-overflow-tooltip></el-table-column>
    ...
    <el-dialog v-model="drawer" :title="Params.id ? '更新' : '添加'">
        <el-form :model="Params" ref="formRef">
            ...
            <el-form-item label="使用类型" prop="useType">
                <el-select v-model="Params.useType" class="m-2" placeholder="请选择使用类型">
                    <el-option label="全场通用" value="0" />
                    <el-option label="指定分类" value="1" />
                    <el-option label="指定商品" value="2" />
                </el-select>
            ...
            <el-form-item label="每人限领张数" prop="perLimit">
                <el-input placeholder="请您输入每人限领张数" v-model="Params.perLimit"></el-input>
            </el-form-item>
