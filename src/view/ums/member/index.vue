<template>
        ...
        <el-form :inline="true">
            ...
            <el-form-item>
                <el-button type="primary" size="default" @click="search"
                    :disabled="username.length || phone.length || status.length ? false : true">
                    搜索
                </el-button>
    ...
    <el-card>
        ...
        <el-table border :data="ListArr" @selection-change="selectChange" style="margin: 15px 0">
            ...
            <el-table-column label="工作" align="center" prop="job" show-overflow-tooltip></el-table-column>
            <el-table-column label="邮箱" align="center" prop="email" show-overflow-tooltip></el-table-column>
            <el-table-column label="城市" align="center" prop="city" show-overflow-tooltip></el-table-column>
            <el-table-column label="个性签名" align="center" prop="signature" show-overflow-tooltip></el-table-column>
            ...
            <el-table-column label="操作" width="300px" align="center">
                <template #="{ row }">
                    ...
                    <el-button type="primary" size="small" icon="Edit" @click="loginLog(row.id)">
                        登录日志
                    </el-button>
                </template>
            </el-table-column>
    ...
    <el-dialog v-model="drawer" :title="userParams.id ? '更新会员' : '添加会员'">
        <el-form :model="userParams" :rules="rules" ref="formRef">
            ...
            <el-form-item label="城市" prop="city">
                <el-input placeholder="请您输入城市" v-model="userParams.city"></el-input>
            </el-form-item>
            <el-form-item label="个性签名" prop="signature">
                <el-input placeholder="请您输入个性签名" v-model="userParams.signature"></el-input>
            </el-form-item>
            <el-form-item label="工作" prop="job">
                <el-input placeholder="请您输入工作" v-model="userParams.job"></el-input>
            </el-form-item>
