<template>
    ...
    <el-card style="margin: 10px 0">
        <el-table border :data="listArr" @selection-change="selectChange">
            ...
            <el-table-column label="退款金额" align="center" prop="returnAmount" show-overflow-tooltip></el-table-column>
    ...
    <el-dialog v-model="drawer" title="订单详情" width="70%">
        ...
        <el-descriptions title="服务单信息" direction="horizontal" :column="1" :size="size" border
            ...
            <el-descriptions-item label="退货金额">{{ orderInfo.returnAmount }}</el-descriptions-item>
...
import { reqReturnApplyAll } from '@/api/oms/returnApply'
//setting仓库
