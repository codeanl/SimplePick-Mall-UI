...
export const reqMemberAll = (current: number, pageSize: number, username: string, phone: string, status: string) =>
    request.get<any, any>(API.ALLMember_URL, { params: { current, pageSize, username, phone, status } });
